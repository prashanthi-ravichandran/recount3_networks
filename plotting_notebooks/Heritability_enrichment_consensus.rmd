...
title_normal <- ggdraw() + 
    draw_label(
      "Meta-Analysis of 42 Independent Traits (Non-cancer consensus)",
      fontface = 'bold',
      x = 0,
      size = 16,
      hjust = 0
...
consensus_res$net[consensus_res$net == "Non-cancerous consensus"] <- "Non-cancer consensus"
consensus_res$net <- factor(consensus_res$net, levels = c("Universal consensus", "Non-cancer consensus"))
...
title_normal <- ggdraw() + 
    draw_label(
      "Meta-Analysis of 219 UKBB Traits (Non-cancer consensus)",
      fontface = 'bold',
      x = 0,
      size = 16,
      hjust = 0
...
consensus_UKBB$net <- as.character(consensus_UKBB$net)
consensus_UKBB$net[consensus_UKBB$net == "Non-cancerous consensus"] <- "Non-cancer consensus"
consensus_UKBB$net <- factor(consensus_UKBB$net, levels = c("Universal consensus", "Non-cancer consensus"))
