...
networks <- c("Universal consensus", "Non-cancerous consensus", "Cancerous consensus")
...
summary_df$networks <- factor(summary_df$networks, levels = c("Universal consensus", "Non-cancerous consensus", "Cancerous consensus"))
...
normal_consensus_res$type <- "Non-cancerous consensus"
cancer_consensus_res$type <- "Cancerous consensus"
consensus_res <- rbind(all_consensus_res, normal_consensus_res, cancer_consensus_res)
consensus_res$type <- factor(consensus_res$type, levels = c("Universal consensus", "Non-cancerous consensus", "Cancerous consensus"))
...
ggplot(dat = consensus_res[consensus_res$n.edges<=500000 & consensus_res$n.edges>=5000,], aes(x = log10(n.edges), y = F1score, col = type, shape = type))+
  ...
  scale_shape_manual(name = "", values = c("Universal consensus" = 15, "Non-cancerous consensus" = 16,"Cancerous consensus" = 17)) +
