...
do
  ...
  sbatch run_odds_ratio.sh sra_normal weighted_cov_networks $K
  sbatch run_odds_ratio.sh sra_normal unweighted_cov_networks $K
  sbatch run_odds_ratio.sh sra_normal correcting_after_pooling $K
  sbatch run_odds_ratio.sh sra_normal pooling_after_correcting $K  
done